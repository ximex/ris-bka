...
module.exports = function (query, cbOk, cbFail) {
  ...
  SOAPRequest(function (PARAMS) {
    ...
    // TODO: Wait for fix of empty namespace (https://github.com/highsource/jsonix/issues/62)
    OGDSearchRequest = OGDSearchRequest
      .replace('xmlns:xmlns="http://ris.bka.gv.at/Search/1.3/OGD"', 'xmlns="http://ris.bka.gv.at/Search/1.3/OGD"');
